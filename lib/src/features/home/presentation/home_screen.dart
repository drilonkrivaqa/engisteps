...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // ✅ favoritesProvider is AsyncValue<List<String>>
    // but some parts of the file expect AsyncValue<Set<String>>.
    // So we convert it cleanly here.
    ...
    final countsByCategory = <String, int>{
      for (final category in categories)
        category: ToolRegistry.tools.where((tool) => tool.category == category).length,
    };
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${countsByCategory[category]} tools',
